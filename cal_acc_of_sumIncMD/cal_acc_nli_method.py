...
f = open('/home/lsm/code/2021/transformers/examples/pytorch/text-classification/scibert_for_sci/predict_v2/predict_results_None.txt','r')
...
lines = []
for prediction in all_lines:
    if prediction == 'contrasting':
       lines.append('0')
    else:
       lines.append('1')
